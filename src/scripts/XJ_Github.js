...
export var XJ_Github={
    ...
    Get_BlogList:(user,jsonPath='Blog/BlogList.json',force=false)=>Promise,//从用户主页仓库({user}.github.io)中获取路径名为{Blog/BlogList.json}下的json文件内容，便于加载博客数据
...
function Get_BlogList(user,jsonPath='Blog/BlogList.json',force=false){
    let _this=this;
